...
namespace GFS.Domain
{
    public class Data
    {
        ...
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 26, nameOption = "View System Activities", controller = "Activities", action = "Index", imageClass = "fa fa-user", estatus = true, isParent = false, parentId = 0 });
            return menu.ToList();
        }
        ...
        public IEnumerable<Roles> roles()
        {
            ...
            roles.Add(new Roles { rowid = 26, idUser = 1, idMenu = 26, status = true });
            return roles.ToList();
        }
