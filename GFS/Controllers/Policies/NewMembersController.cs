...
namespace GFS.Controllers.Policies
{
    public class NewMembersController : Controller
    {
        ...
        public ActionResult Index(string searchBy, string search)
        {
            ...
            if (search != null)
            {
                if (searchBy == "policyNo")
                {
                    ...
                    NewMember d = db.NewMembers.ToList().Find(r => r.policyNo == search);
                    if(d!=null)
                    {
                ...
                if (searchBy == "IdNo")
                {
                    NewMember d = db.NewMembers.ToList().Find(r => r.IdNo == search);
                    if (d != null)
                    {
                        Session["First Name"] = d.fName;
                        Session["Last Name"] = d.lName;
        ...
        public ActionResult Create()
        {
            ...
            var slpQuery = from e in db.SalesPersons select e;
